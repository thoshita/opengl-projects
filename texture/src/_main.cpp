...
#define VERTEX_SHADER_FILE_PATH  "texture/shaders/vertex_shader.glsl"
#define FRAGMENT_SHADER_FILE_PATH "texture/shaders/fragment_shader.glsl"
#define BITMAP_PATH "texture/turfafildah.bmp"
